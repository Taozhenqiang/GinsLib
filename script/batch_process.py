...
def batch_process_gins(exe_path_input):
    ...
    for folder_name in sub_folders[0:1]:  # 处理单个子文件夹用于测试
        ...
        for conf_file in conf_files:
            ...
            # 命令列表
            commands = [
                # [exe_path,"-k",conf_file,"-p","0","-gins","0","-sys","GERC","-ion","1","-tro","1","-eph","0","-flt","0","-amb","0","-ambt","0","-solt","0"], #spp
                ...
                [exe_path,"-k",conf_file,"-p","2","-gins","0","-sys","GE","-ion","1","-tro","1","-eph","0","-flt","0","-amb","1","-ambt","3","-solt","0"], #ppk
