...
def plot_position(solution):
    ...
    axes[0].plot(time, delta[:, 0], color=Fcolor[0], linestyle='-', marker='.')
    ...
    axes[1].plot(time, delta[:, 1], color=Fcolor[1], linestyle='-', marker='.')
    ...
    axes[2].plot(time, delta[:, 2], color=Fcolor[2], linestyle='-', marker='.')
