...
extern Debug_Glo_t DebugGlo_init(Debug_Glo_t Debug_Glo)
{
    time2epoch(Debug_Glo.tNow,Debug_Glo.ctNow);
    Debug_Glo.sow=time2gpst(Debug_Glo.tNow,&Debug_Glo.week);
    sprintf(Debug_Glo.chTime,"%02.0f:%02.0f:%05.2f  %010.2f%c",Debug_Glo.ctNow[3],Debug_Glo.ctNow[4],Debug_Glo.ctNow[5],Debug_Glo.sow,'\0');
